  ...
  return (
    <div className="flex items-center justify-center flex-wrap">
      ...
      {users && users.map((user, index) => (
          <div
          key={index}
          className="box bg-[#B6B3F3] h-[70vh] w-[26vw] rounded-[15px] border-[7px] border-[white] p-3 flex flex-col"
        >
          ...
          <div className="userName&ProfilePic flex h-[23vh] items-center justify-center flex-col">
            ...
            <div className="userName font-semibold mt-1">{user.login.username}</div>
          </div>
          ...
          <div className="locaCont  flex items-center gap-5 justify-center h-[6vh]">
            <div
              ...
              onClick={()=>openGoogleMap(user.location.coordinates.latitude, user.location.coordinates.longitude)}
            >
              <img
